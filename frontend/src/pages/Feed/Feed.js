...
class Feed extends Component {
  ...
  finishEditHandler = postData => {
    ...
    .then(res => {
      let graphqlQuery = {
        query: `
          mutation addPost($title: String!, $imageUrl: String!, $content: String!){
      ...
      if (this.state.editPost){
        graphqlQuery = {
          query: `
            mutation updatePost($postId: ID!, $title: String!, $imageUrl: String!, $content: String!) {
              updatePost(postId: $postId, postInput: {title: $title, imageUrl: $imageUrl, content: $content}){
                _id,
                title,
                content,
                imageUrl,
    ...
    .then(resData => {
      ...
      const post = {
        ...
        content: resData.data[lookupField].content,
        creator: resData.data[lookupField].creator.name,
        createdAt: resData.data[lookupField].createdAt,
        imagePath: resData.data[lookupField].imageUrl,
      };
      this.setState(prevState => {
